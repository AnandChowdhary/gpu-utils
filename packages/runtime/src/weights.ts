...
export function decodeInt6(encoded: string, tensors: TensorEntry[]): Float32Array {
...
export function tensor(weights: Float32Array, manifest: ModelManifest, name: string): Float32Array {

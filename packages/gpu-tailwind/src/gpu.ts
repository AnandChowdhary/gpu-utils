...
/** WebGPU forward pass over a batch on the canonical scan kernel (one workgroup per sequence in the scan pass). */
...
/** WebGPU forward pass. Produces the same logits as forwardCpu (training/tests/test_wgsl.py checks this on lavapipe). */
